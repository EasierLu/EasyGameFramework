...
{
    public class CachedLinkedList<T> : ICollection<T>, IEnumerable<T>, ICollection, IEnumerable
    {
        ...
        public void RemoveFirst()
        {
            ...
            if (first == null)
            {
                throw new CachedLinkedListException("First is invalid.");
            }
        ...
        public void RemoveLast()
        {
            ...
            if (last == null)
            {
                throw new CachedLinkedListException("Last is invalid.");
            }
        ...
        public struct Enumerator : IEnumerator<T>, IEnumerator
        {
            ...
            internal Enumerator(LinkedList<T> linkedList)
            {
                if (linkedList == null)
                {
                    throw new CachedLinkedListException("Linked list is invalid.");
                }
    ...
    internal class CachedLinkedListException : Exception
    {
        public CachedLinkedListException(string message) : base(message)
        {
        }
    }
}
